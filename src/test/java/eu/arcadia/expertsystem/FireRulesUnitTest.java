...
public class FireRulesUnitTest {

    private static final Logger logger = Logger.getLogger(FireRulesUnitTest.class.getName());
    ...
    public void testTranslationRuleToDRL() {
        ...
        when = RuleUtil.convertToRule(when, jsonrulewhen, "AND","1m");
